...
import TestarIA from "./pages/TestarIA";
...
function Router() {
  ...
  const isRequiredOperationalModule = (moduleId: string) => ["dashboard", "canais", "atendimento", "agendamentos", "configuracoes"].includes(moduleId);
  ...
  return (
    <Switch>
      ...
      <Route path="/testar-ia" component={TestarIA} />
      <Route path="/campanhas" component={Campanhas} />
      <Route path="/atendimento" component={CentralAtendimento} />
