...
export default function AdminClienteConexao() {
  const [, params] = useRoute("/admin/cliente/:empresaId");
        ...
        <div className="container mx-auto px-4 py-8">
          <div className="mb-8 flex items-center justify-between">
            <div>
              ...
              <p className="typography-body text-muted-foreground ml-12">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8">
            ...
            <div className="space-y-4">
              ...
              <Card className="border border-border bg-muted/50">
                <CardHeader>
                  <CardTitle className="text-base text-sm">Instruções</CardTitle>
                </CardHeader>
